...
APOTRIS_DATAINIT_DIR = $(TARGET_DIR)/usr/share/batocera/datainit/roms/apotris
...
define APOTRIS_EVMAPY
	install -Dm 644 -t $(TARGET_DIR)/usr/share/evmapy \
	        $(BR2_EXTERNAL_BATOCERA_PATH)/package/batocera/ports/apotris/apotris.keys
endef
